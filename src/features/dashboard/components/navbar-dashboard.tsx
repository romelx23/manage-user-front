...
export const NavbarDashboard = () => {
    ...
    return (
        ...
        <nav className="sticky top-0 navbar-color z-50 shadow-md transition-colors">
            <div
            ...
            >
                ...
                >
                    <img src="https://res.cloudinary.com/react-romel/image/upload/v1729097526/user-interface_msfgbk.png" className="h-8" alt="Flowbite Logo" />
